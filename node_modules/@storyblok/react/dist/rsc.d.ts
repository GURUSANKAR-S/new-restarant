...
export declare const getStoryblokApi: () => StoryblokClient;
...
export declare const StoryblokLiveEditing: ({ story, bridgeOptions }: {
    story: ISbStoryData;
...
export declare const StoryblokStory: ForwardRefExoticComponent<Omit<StoryblokStoryProps, "ref"> & RefAttributes<HTMLElement>>;

declare interface StoryblokStoryProps extends Omit<Record<string, unknown>, 'story' | 'bridgeOptions'> {
    story: ISbStoryData;
    bridgeOptions?: StoryblokBridgeConfigV2;
}
